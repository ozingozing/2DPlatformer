...
public class Entity : MonoBehaviour
{
    ...
    public virtual void Update()
    {
        ...
        anim.SetFloat("yVeloceity", rb.velocity.y);
    ...
    public virtual bool CheckGound()
    {
	...
	public virtual void OnDrawGizmos()
	{
        ...
        Gizmos.DrawWireSphere(playerCheck.position + (Vector3)(Vector2.right * entityData.closeRangeActionDistace), 0.2f);
